  ...
  const fetchReportById = useCallback(
    async (id: string) => {
      ...
      try {
        ...
        if (localRequestId === requestIdRef.current) setError('Failed to fetch report by ID.');
        return null;
      } finally {
        if (localRequestId === requestIdRef.current) setLoading(false);
      }
  ...
  const updateReport = useCallback(
    async (id: string, reportData: Partial<Report>) => {
      ...
      try {
        ...
        if (localRequestId === requestIdRef.current) setError('Failed to update report.');
      } finally {
        if (localRequestId === requestIdRef.current) setLoading(false);
      }
    },
  ...
  const approveReports = useCallback(
    async (ids: string[]) => {
      ...
      try {
        ...
        if (localRequestId === requestIdRef.current) setError('Failed to approve reports.');
      } finally {
        if (localRequestId === requestIdRef.current) setLoading(false);
      }
    },
  ...
  const deleteReport = useCallback(
    async (id: string) => {
      ...
      try {
        ...
        if (localRequestId === requestIdRef.current) setError('Failed to delete report.');
      } finally {
        if (localRequestId === requestIdRef.current) setLoading(false);
      }
    },
  ...
  const exportReports = useCallback(
    async (filters: Record<string, any> = {}): Promise<string | null> => {
      ...
      try {
        ...
        if (localRequestId === requestIdRef.current) setError('Failed to export reports.');
        return null;
      } finally {
        if (localRequestId === requestIdRef.current) setLoading(false);
      }
