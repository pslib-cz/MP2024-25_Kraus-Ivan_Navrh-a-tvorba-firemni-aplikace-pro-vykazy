...
import Select, { SingleValue, MenuPlacement } from 'react-select';
...
// Interface pro InputGroup komponentu
...
const InputGroup: FC<InputGroupProps> = ({
  ...
  // Aktualizace hodnoty inputu při změně value
  useEffect(() => {
  ...
  // Funkce pro změnu hodnoty inputu
  ...
  // Aktuální hodnota selectu
  const currentValue = (() => {
    if (!value) return null;
    const valKey = typeof value === 'object' ? (value as Option).value : value;
