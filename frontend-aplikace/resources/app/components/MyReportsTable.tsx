...
const MyReportsTable: React.FC<MyReportsTableProps> = ({
  ...
  // Sledování scrollu pro sticky headers
  useEffect(() => {
    const handleScroll = () => {
              ...
              {headerGroup.headers.map((header, index) => {
                ...
                const handleDrop = (e: React.DragEvent<HTMLTableCellElement>) => {
                  ...
                  onColumnOrderChange((oldOrder) => {
                    ...
                    const toIndex = currentOrder.indexOf(header.id);
                    ...
                    localStorage.setItem('myReportsColumnOrder', JSON.stringify(newOrder));
