...
const AllReportCards: React.FC<AllReportCardsProps> = ({
  ...
  // Filtrace reportů, které je možné vybrat (tj. nejsou schválené)
  const selectableReports = reports?.filter((report) => !report.approved) || [];

  // Přepínání stavu rozbalení karty
              ...
              <div className={styles.topRow}>
                <div className={styles.rowContent}>
                  <div className={styles.dateContainer}>
                    {/* checkbox pro výběr reportu - zobrazen jen u neschválených */}
                    {!report.approved && (
                      <input
                        type="checkbox"
