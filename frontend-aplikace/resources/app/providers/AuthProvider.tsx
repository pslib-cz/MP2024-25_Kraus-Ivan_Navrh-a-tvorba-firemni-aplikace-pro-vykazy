...
// Definice typů akcí pro reducer
...
// Reducer pro správu stavů uživatele
...
// Kontext pro Auth data a funkce
...
export const AuthProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  // Přepnutí zobrazení všech úkolů
  ...
  const msLogin = async () => {
    ...
    // otevření popup okna a načtení kódu
