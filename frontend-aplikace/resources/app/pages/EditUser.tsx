...
// Pomocná funkce pro rekurzivní zjištění všech podřízených uživatelů
...
const EditUser: React.FC = () => {
  ...
  // Lokální stavy pro uživatele a nadřízené
  ...
  // Odstranění uživatele a jeho podřízených z možností nadřízených
  useEffect(() => {
  ...
  // Ošetření chyb při načítání roles a jobTitles
